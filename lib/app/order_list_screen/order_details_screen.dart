                              ...
                              child: Column(
                                children: [
                                  ...
                                  controller.orderModel.value.takeAway == true
                                      ...
                                      : Row(
                                          ...
                                          children: [
                                            ...
                                            (controller.orderModel.value.vendor?.isSelfDelivery == true || controller.orderModel.value.isFreeDelivery == true)
                                                ? Text(
                                                    'Free Delivery'.tr,
                                                    textAlign: TextAlign.start,
                                                    style: TextStyle(
                                                ...
                                                : Text(
                                                    Constant.amountShow(
                                                        amount: controller.orderModel.value.deliveryCharge == null || controller.orderModel.value.deliveryCharge?.isEmpty == true
                                                            ? "0.0"
                                  ...
                                  controller.orderModel.value.specialDiscount != null && controller.orderModel.value.specialDiscount!['special_discount'] != null
                                      ...
                                      : const SizedBox(),
                                  ((controller.orderModel.value.takeAway == true || controller.orderModel.value.vendor?.isSelfDelivery == true) || controller.orderModel.value.isFreeDelivery == true)
                                      ? const SizedBox()
                                      : Column(
                                          children: [
                                            const SizedBox(
                                            ...
                                            Text(
                                              Constant.amountShow(
                                                  amount: Constant.calculateTax(
                                                          amount: (controller.subTotal.value - double.parse(controller.orderModel.value.discount.toString()) - controller.specialDiscountAmount.value)
                                                              .toString(),
                                                          taxModel: taxModel)
                                                      .toString()),
                                              textAlign: TextAlign.start,
                          ...
                          if (controller.orderModel.value.paymentMethod!.toLowerCase() != 'cod') {
                            ...
                            if (controller.orderModel.value.isFreeDelivery == true) {
                              finalAmount = (controller.subTotal.value +
                                  ...
                                  double.parse(controller.taxAmount.value.toString()));
                            } else {
                              finalAmount = (controller.subTotal.value +
                                  double.parse(controller.orderModel.value.discount.toString()) +
                                  controller.specialDiscountAmount.value +
